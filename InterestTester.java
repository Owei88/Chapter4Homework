...
public class InterestTester {
    public static void main(String[] args) {
        ...
        System.out.printf("Balance for the first month is %.2f\n",
                InterestCalculator.getMonthOneBalance(initBalance, interestRate));
        System.out.printf("Balance for the second month is %.2f\n" ,
                InterestCalculator.getMonthTwoBalance(initBalance, interestRate));
        System.out.printf("Balance for the third month is %.2f" ,
                InterestCalculator.getMonthThreeBalance(initBalance, interestRate));
    }
}
